...
-- yaml, json
vim.keymap.set('n', '<leader>yj', ':%!yq -o=json<CR> :set filetype=json<CR>', { desc = 'Convert YAML in buffer to JSON' })
vim.keymap.set('n', '<leader>jy', ':%!yq -P<CR> :set filetype=yaml<CR>', { desc = 'Convert JSON in buffer to YAML' })
